...
group = "dev.redstudio"
version = "1.1.2" // Versioning must follow Ragnarök versioning convention: https://github.com/Red-Studio-Ragnarok/Commons/blob/main/Ragnar%C3%B6k%20Versioning%20Convention.md
...
dependencies {
	...
	val mixinBooter: String = modUtils.enableMixins("zone.rong:mixinbooter:8.4", "mixins.${id}.refmap.json") as String
	api(mixinBooter) {
		isTransitive = false
	}
...
buildConfig {
	...
	buildConfigField("String", "NAME", "\"Wither Config\"")
